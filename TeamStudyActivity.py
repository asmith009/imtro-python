...
def animalLimbs():
    ...
    chicken = 2
    goat = 4
    UserInput = input('Name one farm animal. ')
    if UserInput == 'Cow':
        print('This animal has 4 limbs. ')
    elif UserInput == 'chicken':
        print('This animal has 2 limbs. ')
    elif UserInput == 'goat':
        print('This animal has 4 limbs. ')
...
def quizgame():
    Answer = input('How old is Jamir? ')
    if Answer == '15':
        print('Congrats, You got it correct! ')
    Answer = input('What is jamir favorite color? ')
    if Answer == 'Navy Blue':
        print('Congrats, You got it correct! ')
    Answer = input('What is Jadens birthMonth? ')
    if Answer == 'september':
        print('Congrats, you got it correct! ')
    Answer = input('What is Jadens favorite sport? ')      
